...
void display_title()		//displays the games title screen
{
	...
	textcolor(11);
	gotoxy(x,y++);cprintf("������ ����Ŀ ����Ŀ �����  ����� ");
	gotoxy(x,y++);cprintf("�      �    � �    � �      �     ");
	gotoxy(x,y++);cprintf("����Ŀ ������ ����Ĵ �      ����� ");
	gotoxy(x,y++);cprintf("     � �      �    � �      �     ");
	gotoxy(x,y++);cprintf("������ �      �    � �����  ����� ");

	x=10,y=13;
	textcolor(13+BLINK);
	gotoxy(x,y++);cprintf(" ����� ����Ŀ  �%c%c%c%c%c%c%c� ����Ŀ ����,  �����  ����Ŀ  ������  ",4,4,4,4,4,4,4);
	gotoxy(x,y++);cprintf("   �   �    �  ��%c   %c�� �    � �    \\ �      �    �  �      ",4,4);
	gotoxy(x,y++);cprintf("   �   �    �   ��%c %c��  ����Ĵ �    � �����  ������  ����Ŀ  ",4,4);
	gotoxy(x,y++);cprintf("   �   �    �    ��%c��   �    � �    / �      �'\\          �  ",4);
	gotoxy(x,y++);cprintf(" ����� �    �     ���    �    � ����'  �����  �   \\   ������  ");
	getch();
